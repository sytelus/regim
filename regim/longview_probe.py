...
class LongviewProbe(Probe):
    def __init__(self, exp_name, run_name, epoch_config, model, 
        ...
        self.lv.set_globals(model=model, metrics=metrics.stats)
    ...
    def on_after_batch(self, train_test, batch_state):
        ...
        self.lv.observe("batch", x=self.metrics.stats.epochf, batch=batch_state, tt=train_test)
    ...
    def on_after_epoch(self, train_test, loader):
        ...
        self.lv.observe("epoch", tt=train_test)
